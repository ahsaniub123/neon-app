...
@section('content')
    ...
    <div class="row">
        <div class="col-6" style="padding-left: 0;">
            <h3>New Bulk Character Dimensions</h3>
        </div>
    ...
    <div class="row mt-2">
        <div class="col-12">
            {{--            {{ route('board.save') }}--}}
            <form id="board-price-form" action="{{ route('bulk-char-dimen.save')}}" method="post">
                @csrf
                <div class="row">
                    <table class="js-table-sections table  table-vcenter variants-table">
                        ...
                        <tr class="text-center toggle-tr">
                            ...
                            <td class="font-w600 font-size-sm" style=" width: 10%;">
                                Length
                            </td>
                            <td class="font-w600 font-size-sm" style=" width: 10%;">
                                Height

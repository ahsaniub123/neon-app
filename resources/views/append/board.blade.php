...
{{--    <p>{{json_encode($text)}}</p>--}}
    ...
    class="board @if($board_width != null && $board_length != null) @if($board_width == $board->width && $board_length == $board->length) active @endif @endif"
         ...
         data-price="
         @if($b_length * $for_multiply > 18) {{round((($b_price * $for_multiply) * 18) / ($b_length * $for_multiply) )}} @else {{round($b_price * $for_multiply)}} @endif
@if($b_length * $for_multiply > 25) {{round((($b_price * $for_multiply) * 25) / ($b_length * $for_multiply) )}} @else {{round($b_price * $for_multiply)}} @endif
@if($b_length * $for_multiply > 35) {{round((($b_price * $for_multiply) * 35) / ($b_length * $for_multiply) )}} @else {{round($b_price * $for_multiply)}} @endif
@if($b_length * $for_multiply > 47) {{round((($b_price * $for_multiply) * 47) / ($b_length * $for_multiply) )}} @else {{round($b_price * $for_multiply)}} @endif
@if($b_length * $for_multiply > 60) {{round((($b_price * $for_multiply) * 60) / ($b_length * $for_multiply) )}} @else {{round($b_price * $for_multiply)}} @endif
@if($b_length * $for_multiply > 80) {{round((($b_price * $for_multiply) * 80) / ($b_length * $for_multiply) )}} @else {{round($b_price * $for_multiply)}} @endif
         ">
